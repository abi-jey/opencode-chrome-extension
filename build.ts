...
await $`bun build --compile src/native-host/index.ts --outfile bin/browser_companion_host`
console.log("Native host binary compiled to bin/browser_companion_host")
